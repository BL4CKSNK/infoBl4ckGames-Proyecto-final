...
const Canvas = ({ juegos, setFilteredJuegos, categoriasUnicas, isOpen, toggleSidebar }) => {
    ...
    return (
        <>
            ...
            <div
                className={`fixed top-0 left-0 h-full bg-gray-800 text-white w-64 transform z-50 ${
            ...
            >
                ...
                <div className="p-4">
                    ...
                    <h1 className="text-lg font-semibold mb-2">Categorías</h1>
                    <select
                        value={selectedCategoria}
                        onChange={handleCategoriaChange}
                        className="bg-indigo-500 text-white text-xs font-semibold mr-2 px-2.5 py-0.5 rounded"
                    >
                ...
                <div className="p-4">
                    <h1 className="text-lg font-semibold mb-2">Filtrar por Año de Lanzamiento</h1>
                    <select
                        value={selectedYear}
                ...
                <div className="p-4">
                    <h1 className="text-lg font-semibold mb-2">Ordenar por Título</h1>
                    <select
                ...
                <div className="p-4">
                    <span className="text-lg font-semibold mb-2">Rango de Precios</span>
                ...
                <div className="p-4">
                    <h1 className="text-lg font-semibold mb-2">Filtrar por Fecha de Lanzamiento</h1>
                    <div className="flex items-center">
